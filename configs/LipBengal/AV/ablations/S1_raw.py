"""
Ablation Config: S1_raw - LipBengal
...
# Script Normalization: RAW (using original Bengali script - expected to fail)
...
training_dataset = nnet.datasets.LipBengal(
    ...
    subset_seed=42,
    prepared_only=True,
    label_format="raw",  # Use raw Bengali script
)
...
accumulated_steps = 1
eval_training = False
callback_path = "callbacks/LipBengal/AV/ablations/S1_raw"
verbose_eval = 1
eval_period_epoch = 1
