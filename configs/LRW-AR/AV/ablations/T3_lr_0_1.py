"""
Ablation Config: T3_lr_0_1 - LRW-AR
...
ENCODER_LR_MULT = float(os.environ.get("ENCODER_LR_MULT", 0.1))
...
if FREEZE_ENCODER_EPOCHS > 0 and TRANSFER_MODE != "scratch":
    ...
    print(f"[Ablation T3_lr_0_1] Frozen: {frozen}, Trainable: {kept} for {FREEZE_ENCODER_EPOCHS} epochs")
    ...
    if epoch == FREEZE_ENCODER_EPOCHS and TRANSFER_MODE != "scratch":
        ...
        for p in model.encoder.parameters():
            if not p.requires_grad:
                ...
                unfroze += 1
        if unfroze:
            print(f"[Ablation T3_lr_0_1] Unfroze {unfroze} params at epoch {epoch}")
    return res
...
accumulated_steps = 1
eval_training = False
callback_path = "callbacks/LRW-AR/AV/ablations/T3_lr_0_1"
verbose_eval = 1
eval_period_epoch = 1
