...
lrs2_username = "lrs3061" # Set to your lrs2 username
lrs2_password = "eHohbie9" # Set to your lrs2 password
...
lrs2_dataset = nnet.datasets.LRS(None, None, version="LRS2", download=True, prepare=True, tokenizer_path=tokenizer_path, mean_face_path=mean_face_path, workers_prepare=workers_prepare, mode="pretrain+train+val", prepare_subset_fraction=0.3, prepare_subset_seed=0)
