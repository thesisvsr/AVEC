#!/usr/bin/env python3
"""
Comprehensive Evaluation for LRW-AR S1_phonetic (Transliteration/Arabish Ablation)
...
def main():
    # Checkpoint path
    checkpoint_path = "callbacks/LRW-AR/AV/ablations/S1_phonetic/checkpoints_epoch_327_step_163106.ckpt"
    config_path = 'configs.LRW-AR.AV.ablations.S1_phonetic'
    
    print("=" * 80)
    print("  LRW-AR S1_PHONETIC (TRANSLITERATION/ARABISH) EVALUATION")
    print("=" * 80)
    ...
    args.config_file = 'configs/LRW-AR/AV/ablations/S1_phonetic.py'
    args.config = config
    ...
    # Print results
    print("\n" + "=" * 80)
    print("  RESULTS: LRW-AR S1_PHONETIC (TRANSLITERATION/ARABISH ABLATION)")
    print("=" * 80)
    ...
    output_file = "LRWAR_S1_phonetic_evaluation_results.txt"
    with open(output_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("  LRW-AR S1_PHONETIC (TRANSLITERATION/ARABISH) EVALUATION RESULTS\n")
        f.write("=" * 80 + "\n\n")
