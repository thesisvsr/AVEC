#!/usr/bin/env python3
"""
Comprehensive Evaluation for LRW-AR T3_lr_0_1 (Learning Rate 0.1x Ablation)
...
def main():
    # Checkpoint path - use epoch 98 (epoch 99 might be incomplete based on file size)
    checkpoint_path = "callbacks/LRW-AR/AV/ablations/T3_lr_0_1/checkpoints_epoch_98_step_48882.ckpt"
    config_path = 'configs.LRW-AR.AV.ablations.T3_lr_0_1'
    
    print("=" * 80)
    print("  LRW-AR T3_LR_0_1 (LEARNING RATE 0.1x) EVALUATION")
    print("=" * 80)
    ...
    args.config_file = 'configs/LRW-AR/AV/ablations/T3_lr_0_1.py'
    args.config = config
    ...
    # Print results
    print("\n" + "=" * 80)
    print("  RESULTS: LRW-AR T3_LR_0_1 (LEARNING RATE 0.1x ABLATION)")
    print("=" * 80)
    ...
    output_file = "LRWAR_T3_lr_0_1_evaluation_results.txt"
    with open(output_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("  LRW-AR T3_LR_0_1 (LEARNING RATE 0.1x) EVALUATION RESULTS\n")
        f.write("=" * 80 + "\n\n")
        ...
        f.write("- Differential LR: encoder_lr_scale = 0.1 (10% of head LR)\n")
