#!/usr/bin/env python3
"""
Comprehensive Evaluation for LipBengal S1_raw (Raw Bengali Script Ablation)
...
def main():
    # Checkpoint path
    checkpoint_path = "callbacks/LipBengal/AV/ablations/S1_raw/checkpoints_epoch_100_step_137045.ckpt"
    config_path = 'configs.LipBengal.AV.ablations.S1_raw'
    
    print("=" * 80)
    print("  LIPBENGAL S1_RAW (RAW BENGALI SCRIPT) EVALUATION")
    print("=" * 80)
    ...
    args.config_file = 'configs/LipBengal/AV/ablations/S1_raw.py'
    args.config = config
    ...
    # Print results
    print("\n" + "=" * 80)
    print("  RESULTS: LIPBENGAL S1_RAW (RAW BENGALI SCRIPT ABLATION)")
    print("=" * 80)
    ...
    output_file = "LipBengal_S1_raw_evaluation_results.txt"
    with open(output_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("  LIPBENGAL S1_RAW (RAW BENGALI SCRIPT) EVALUATION RESULTS\n")
        f.write("=" * 80 + "\n\n")
        ...
        f.write("=" * 80 + "\n")
        f.write("- Script Normalization: RAW (original Bengali script)\n")
        f.write("- No transliteration applied\n")
        f.write("- Labels use native Bengali characters\n")
