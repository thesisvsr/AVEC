#!/usr/bin/env python3
"""
Comprehensive Evaluation for LRW-AR T3_lr_0_5 (Learning Rate 0.5x Ablation)
...
def main():
    # Checkpoint path - use epoch 99
    checkpoint_path = "callbacks/LRW-AR/AV/ablations/T3_lr_0_5/checkpoints_epoch_99_step_49383.ckpt"
    config_path = 'configs.LRW-AR.AV.ablations.T3_lr_0_5'
    
    print("=" * 80)
    print("  LRW-AR T3_LR_0_5 (LEARNING RATE 0.5x) EVALUATION")
    print("=" * 80)
    ...
    args.config_file = 'configs/LRW-AR/AV/ablations/T3_lr_0_5.py'
    args.config = config
    ...
    # Print results
    print("\n" + "=" * 80)
    print("  RESULTS: LRW-AR T3_LR_0_5 (LEARNING RATE 0.5x ABLATION)")
    print("=" * 80)
    ...
    output_file = "LRWAR_T3_lr_0_5_evaluation_results.txt"
    with open(output_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("  LRW-AR T3_LR_0_5 (LEARNING RATE 0.5x) EVALUATION RESULTS\n")
        f.write("=" * 80 + "\n\n")
        ...
        f.write("- Differential LR: encoder_lr_scale = 0.5 (50% of head LR)\n")
