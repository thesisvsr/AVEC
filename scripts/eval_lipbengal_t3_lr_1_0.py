#!/usr/bin/env python3
"""
Comprehensive Evaluation for LipBengal T3_lr_1_0 (Learning Rate 1x Ablation)
...
def main():
    # Checkpoint path
    checkpoint_path = "callbacks/LipBengal/AV/ablations/T3_lr_1_0/checkpoints_epoch_100_step_137046.ckpt"
    config_path = 'configs.LipBengal.AV.ablations.T3_lr_1_0'
    
    print("=" * 80)
    print("  LIPBENGAL T3_LR_1_0 (LEARNING RATE 1x) EVALUATION")
    print("=" * 80)
    ...
    args.config_file = 'configs/LipBengal/AV/ablations/T3_lr_1_0.py'
    args.config = config
    ...
    # Print results
    print("\n" + "=" * 80)
    print("  RESULTS: LIPBENGAL T3_LR_1_0 (LEARNING RATE 1x ABLATION)")
    print("=" * 80)
    ...
    output_file = "LipBengal_T3_lr_1_0_evaluation_results.txt"
    with open(output_file, 'w') as f:
        f.write("=" * 80 + "\n")
        f.write("  LIPBENGAL T3_LR_1_0 (LEARNING RATE 1x) EVALUATION RESULTS\n")
        f.write("=" * 80 + "\n\n")
        ...
        f.write("- Differential LR: encoder_lr_scale = 1.0 (same as head LR)\n")
